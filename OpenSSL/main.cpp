...
int main(int argc, char *argv[]){
    ...
    printf("ENCRYPT:\n\n");
    FILE *encode_file = fopen("C:/QT/OpenSSL/1.txt", "rb");
    FILE *decode_file = fopen("C:/QT/OpenSSL/2.txt", "wb");
    ...
    encode_file = fopen("C:/QT/OpenSSL/2.txt", "rb");
    decode_file = fopen("C:/QT/OpenSSL/3.txt", "wb");
